	...
	private static function result_payload(
		...
		return array(
			...
			'actions'     => \sprintf(
				...
				\esc_url( $panel_url ),
				\esc_html__( 'View full breakdown', 'agentready' )
			),
			'test'        => self::TEST_ID,
		);
	}
	...
	private static function humanize_sub_score_name( string $name ): string {
		switch ( $name ) {
			case 'discoverability':
				return \__( 'discoverability', 'agentready' );
			case 'content_readability':
				return \__( 'content readability', 'agentready' );
			case 'schema_coverage':
				return \__( 'schema coverage', 'agentready' );
			case 'exposure_safety':
				return \__( 'exposure safety', 'agentready' );
			case 'integration_health':
				return \__( 'integration health', 'agentready' );
			case 'md_conversion_quality':
				return \__( 'Markdown conversion quality', 'agentready' );
			default:
