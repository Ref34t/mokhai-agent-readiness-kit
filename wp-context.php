...
define( 'WP_CONTEXT_VERSION', '0.1.0-dev' );
define( 'WP_CONTEXT_PLUGIN_FILE', __FILE__ );
define( 'WP_CONTEXT_PLUGIN_DIR', plugin_dir_path( __FILE__ ) );
define( 'WP_CONTEXT_PLUGIN_URL', plugin_dir_url( __FILE__ ) );
