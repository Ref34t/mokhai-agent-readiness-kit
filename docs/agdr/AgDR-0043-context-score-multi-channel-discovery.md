...
- A site running AI Layer alongside AI Readiness Kit no longer loses score for using a complementary discovery surface — coexistence ≠ competition, matching AgDR-0006's positioning.
...
- PR: `Ref34t/agentready#TBD` (will link the merge commit on close).
- Ticket: [Ref34t/agentready#22](https://github.com/Ref34t/agentready/issues/22).
