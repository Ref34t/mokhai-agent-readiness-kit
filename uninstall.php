 ...
 * `WPContext\Support\Uninstaller`, where each key is referenced from the
...
if ( class_exists( \WPContext\Support\Uninstaller::class ) ) {
	\WPContext\Support\Uninstaller::run();
}
